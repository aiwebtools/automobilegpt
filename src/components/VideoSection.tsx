              ...
              <>
                ...
                <div className="absolute inset-0 bg-gradient-to-br from-black/90 to-black/70 flex items-center justify-center">
                  <div className="text-center text-white">
                    ...
                    <button 
                      className="bg-automotive-blue hover:bg-automotive-blue/90 text-white px-6 py-3 rounded-full font-medium inline-flex items-center transition-all neon-border"
